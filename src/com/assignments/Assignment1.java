...
public class Assignment1 {
	...
	public static void main(String[] args) {
		...
		String mailid = "john.deo@gmail.com";
		...
		// Temperature of a city in degrees Celsius: 25.5
				...
				System.out.println("Coordinates of a location: Latitude = " + latitude1 + ", Longitude = " + longitude1);
				...
				String occupation1 = "Software Engineer";
				System.out.println("Person's occupation: " + occupation1);
				...
				String birthplace1 = "New York City";
				System.out.println("Person's birthplace: " + birthplace1);
